...
#define SHOOT_CONTROL_TIME  GIMBAL_CONTROL_TIME_MS
...
//拨弹速度
#define TRIGGER_SPEED  5.0f//原始10,。0
#define Ready_Trigger_Speed 6.0f//原始6.0

#define KEY_OFF_JUGUE_TIME 500
#define SWITCH_TRIGGER_ON 0//子弹到微动开关处
#define SWITCH_TRIGGER_OFF 1//子弹未到微动开关处
...
{
    SHOOT_STOP = 0,//
    SHOOT_READY,//射击准备控制，将子弹送到微动开关处，
    SHOOT_BULLET,//射击控制，控制拨弹电机角度，完成一次发射
    SHOOT_DONE,//射击完成控制，判断微动开关一段时间无子弹来判断一次发射
} shoot_mode_e;
